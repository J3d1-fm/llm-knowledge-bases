...
The signed-in Work DB view renders the label-free tag cloud snapshot above the cards, using the same sanitized `assets/tag-cloud-snapshot.json` as the public homepage. Other workspace tabs hide the graph.
